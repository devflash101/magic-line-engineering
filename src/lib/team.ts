...
export const leadershipTeam: TeamMember[] = [
  {
    ...
    location: "",
    licenses: [],
    bio: "Raymond Liu is the Chief Executive Officer of Magic Line, guiding the firm’s vision across architecture, engineering, and design. He brings a client-focused leadership approach that emphasizes quality, accountability, and long-term partnerships. Raymond works closely with project teams and leadership to ensure every engagement reflects the firm’s standards of excellence from initial concept through successful delivery.",
    tier: "ceo",
  },
  {
    id: "project-manager",
  ...
  },
  {
    ...
    location: "",
    licenses: [],
    bio: "Salina Harper is the Financial Manager at Magic Line, overseeing budgeting, financial planning, and operational reporting for the firm. She supports transparent client billing, cost control, and sustainable business operations behind every project. Salina is dedicated to accuracy, consistency, and building the financial foundation that allows the team to deliver with confidence.",
    tier: "manager",
  },
];
